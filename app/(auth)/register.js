...
import { View, Text, TextInput, TouchableOpacity, Animated, Image, StyleSheet, KeyboardAvoidingView, Platform, ScrollView, StatusBar, Keyboard, LayoutAnimation } from "react-native";
...
export default function RegisterScreen() {
  ...
  return (
    <View style={styles.container}>
      <AnimatedBackground colors={["#8B5CF6", "#3B82F6", "#06B6D4"]}>
          ...
          <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
              ...
              <Animated.View style={{ opacity: cardOpacity, transform: [{ translateY: cardTranslate }] }}>
                <View>
                  ...
                  <View style={styles.header}>
                    <View style={styles.backRow}>
                      <PressableBounce style={styles.backBtn} onPress={() => router.back()}>
                ...
                <PressableBounce style={styles.loginLink} onPress={() => router.back()}>
