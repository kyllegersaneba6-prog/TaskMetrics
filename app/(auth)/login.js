...
import { View, Text, TextInput, TouchableOpacity, Animated, Image, StyleSheet, KeyboardAvoidingView, Keyboard, LayoutAnimation } from "react-native";
          ...
          <KeyboardAvoidingView style={styles.flex} behavior="padding">
            <View style={styles.content}>
              ...
              <Animated.View style={{ opacity: cardOpacity, transform: [{ translateY: cardTranslate }] }}>
                ...
                <PressableBounce style={styles.registerLink} onPress={() => { Keyboard.dismiss(); router.push("/(auth)/register"); }}>
